  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      emergencyContact: Yup.string()
        .max(11, "Emergency Contact must not be longer than 11 characters")
        .matches(
          /^0\d{9,10}$/,
          "Emergency Contact must only contain digits and must be in the format: 0xxxxxxxxx"
        )
    ...
    <>
      {spinner ? (
        ...
        <div className="flex flex-col my-7 items-center w-full">
          {/* -------- Title -------- */}
          <HeaderAdminManagementComponent content={"Update Doctor"} />
          {/* Form */}
          <form
...
export default withAuth(UpdateDoctorPage, adminRole);
