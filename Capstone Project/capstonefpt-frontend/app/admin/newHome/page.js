    ...
    <SemiLocaleProvider locale={en_US}>
      <div className="flex flex-col items-center p-5 gap-4 w-fit">
        ...
        <div className="flex w-full gap-4 justify-center items-center">
          ...
          <div className="w-8/12 h-full min-h-[18rem] p-4 rounded-lg bg-slate-50 border-white border-2">
            <h1 className="mb-4 text-2xl px-10 font-extrabold text-gray-900 dark:text-white text-center">
              <span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">
                Admin
              </span>{" "}
            ...
            <div className="flex flex-wrap justify-center items-center gap-4">
              ...
              <Tooltip content={"Go to Examinated Record management page"}>
        ...
        <div className="flex w-full gap-4 justify-start items-start">
          <div className="w-4/12 text-sm border-white border-2 rounded-lg p-4 font-bold text-justify bg-slate-50 text-gray-800">
            ...
            <div className=" grid grid-cols-2 gap-4">
              <Tooltip content={"Click to view Users Statistics"}>
                <button
                  className="flex items-center justify-center min-w-[11rem] text-sm h-12 bg-[#0096c7] text-white rounded-lg font-bold transition duration-300 hover:bg-[#48cae4] hover:text-white"
                  onClick={toggleUserSideSheet}
                >
                  Users Statistics
                </button>
              </Tooltip>
              <SideSheet
                title={
                  <h1 className="mb-4 text-2xl px-10 font-extrabold text-gray-900 dark:text-white text-center">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">
                      Users Statistics Tracking
                    </span>
                  </h1>
                }
                visible={visibleUserSideSheet}
                onCancel={toggleUserSideSheet}
                size={"large"}
              >
                {" "}
                <div className="mt-4">
                  <h1 className="mb-4 text-2xl px-10 font-extrabold leading-none tracking-tight text-gray-900 dark:text-white">
                    <span className="text-red-400">Users</span> Statistics
                    Tracking
                  </h1>
                </div>
                <div className="flex gap-4 justify-center items-center">
                  {loadingTotalUsers ? (
                    <div className="h-40 rounded-xl shadow-md p-6 bg-blue-400 min-w-[12rem]">
                  ...
                  {loadingTotalStudents ? (
                    <div className="h-40 rounded-xl shadow-md p-6 bg-red-400 min-w-[12rem]">
                      <div className="font-semibold mb-1 text-lg">
                        Total Students
                      </div>
                      <div className="font-semibold text-5xl tracking-tight">
                  ...
                  {loadingTotalStaffs ? (
                    <div className="h-40 rounded-xl shadow-md p-6 bg-green-400 min-w-[12rem]">
                      <div className="font-semibold mb-1 text-lg">
                        Total Staffs
                      </div>
                      <div className="font-semibold text-5xl tracking-tight">
                  ...
                  {loadingTotalDoctors ? (
                    <div className="h-40 rounded-xl shadow-md p-6 bg-purple-400 min-w-[12rem]">
                      <div className="font-semibold mb-1 text-lg">
                        Total Doctors
                      </div>
                      <div className="font-semibold text-5xl tracking-tight">
              ...
              <Tooltip content={"Click to view Feedbacks Statistics"}>
                <button
                  className="flex items-center justify-center min-w-[11rem] text-sm h-12 bg-[#0096c7] text-white rounded-lg font-bold transition duration-300 hover:bg-[#48cae4] hover:text-white"
                  onClick={toggleFeedbackSideSheet}
                >
              ...
              <SideSheet
                title={
                  <h1 className="mb-4 text-2xl px-10 font-extrabold text-gray-900 dark:text-white text-center">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">
                      Feedbacks Statistics Tracking
                    </span>
                  </h1>
                }
                visible={visibleFeedbackSideSheet}
                onCancel={toggleFeedbackSideSheet}
                size={"large"}
              >
                <div className="">
              ...
              <Tooltip content={"Click to view Schedules Statistics"}>
                <button
                  className="flex items-center justify-center min-w-[11rem] text-sm h-12 bg-[#0096c7] text-white rounded-lg font-bold transition duration-300 hover:bg-[#48cae4] hover:text-white"
              ...
              <SideSheet
                title={
                  <h1 className="mb-4 text-2xl px-10 font-extrabold text-gray-900 dark:text-white text-center">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">
                      Schedules Statistics Tracking
                    </span>
                  </h1>
                }
                visible={visibleScheduleSideSheet}
                onCancel={toggleScheduleSideSheet}
                size={"large"}
              >
                {" "}
                <div className="mt-4">
                        ...
                        data: [
                          {
                            ...
                            values: [
                              {
                                status: "All",
                                numberOfSchedule: totalSchedules,
                              },
                              {
                                status: "Accepted",
              ...
              <Tooltip content={"Click to view Medicine Statistics"}>
                <button
                  className="flex items-center justify-center min-w-[11rem] text-sm h-12 bg-[#0096c7] text-white rounded-lg font-bold transition duration-300 hover:bg-[#48cae4] hover:text-white"
                  onClick={toggleMedicineSideSheet}
                >
                  Medicine Statistics
                </button>
              </Tooltip>
              <SideSheet
                title={
                  <h1 className="mb-4 text-2xl px-10 font-extrabold text-gray-900 dark:text-white text-center">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">
                      Medicine Statistics Tracking
                    </span>
                  </h1>
                }
                visible={visibleMedicineSideSheet}
                onCancel={toggleMedicineSideSheet}
                size={"large"}
              >
                {" "}
                <div className="mt-5">
                  <h1 className="mb-4 text-2xl px-10 font-extrabold leading-none tracking-tight text-gray-900 dark:text-white">
                    <span className="text-blue-400">Medicine</span> Statistics
                    Tracking
                  </h1>
                </div>
                <div className="flex gap-4 justify-center items-center">
