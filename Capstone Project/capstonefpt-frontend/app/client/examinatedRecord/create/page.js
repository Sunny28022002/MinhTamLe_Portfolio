...
const CreateExaminatedRecordClientPage = () => {
    ...
    onSubmit: (values) => {
      ...
      axios
        ...
        .then((response) => {
          ...
          router.push("/client/medicalExaminatedRecord/create");
        })
        .catch((error) => {
      ...
      {spinner ? (
        ...
        <div className="flex flex-col my-7 items-center w-full">
          <HeaderAdminManagementComponent
            content={"Create Examinated Record"}
          />
          <form
...
export default CreateExaminatedRecordClientPage;
