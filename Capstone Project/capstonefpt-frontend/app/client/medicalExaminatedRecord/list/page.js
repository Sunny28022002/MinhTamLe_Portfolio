...
import { getRoleFromToken, getValueByIndex } from "@/libs/common";
import Cookies from "js-cookie";

const MedicalExaminatedRecordListClientPage = () => {
    ...
    let columnsTable = [
      {
        title: "MeID",
        dataIndex: "meid",
        sorter: (a, b) => (a.meid - b.meid > 0 ? 1 : -1),
      },
      {
        title: "Record ID",
        dataIndex: "recordId",
              ...
              <Dropdown
                ...
                render={
                  <Dropdown.Menu>
                    <Dropdown.Item>
                      <Link
                        href={`/client/medicalExaminatedRecord/update/${record.meid}`}
                      >
                        <Button
                          style={{
                            color: "#ffffff",
          ...
          <>
            <div className="flex items-center justify-center h-full w-full">
              <div className="text-center">
                ...
                <Link href={"/client/medicalExaminatedRecord/create"}>
...
export default MedicalExaminatedRecordListClientPage;
