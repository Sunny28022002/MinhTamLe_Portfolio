...
const UpdateMedicalExaminatedRecordClientPage = () => {
    ...
    onSubmit: (values) => {
      ...
      axios
        ...
        .then((response) => {
          ...
          router.push("/client/medicalExaminatedRecord/list");
        })
        .catch((error) => {
      ...
      <div key={index} className="w-full flex flex-col gap-3">
        <div className="flex gap-3 w-full justify-between">
          <div className="flex flex-col w-full gap-3 min-h-full">
            <AutoComplete
              ...
              placeholder={`${
                formik.values.medicineUpdatedList[index].medicineName
                  ? formik.values.medicineUpdatedList[index].medicineName
                  : "Enter Medicine Name"
              }`}
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="col-span-1">
            ...
            <Select
              placeholder={`${
                formik.values.medicineUpdatedList[index].isActive
                  ? formik.values.medicineUpdatedList[index].isActive
                  : "Enter Status"
              }`}
              style={{
...
export default UpdateMedicalExaminatedRecordClientPage;
