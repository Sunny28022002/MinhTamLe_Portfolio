...
import { Avatar, Calendar, DatePicker, Radio, RadioGroup, Table, Tooltip } from "@douyinfe/semi-ui";
...
const ScheduleListClientPage = () => {
  ...
  // Handle search schedule by date
  const handleSearch = () => {
    setLoading(true);
      ...
      render: (patientName) => {
        if (patientName != null) {
          return (
           ...
           return <p className="text-red-700">Empty</p>;
        }
      },
    },
    {
